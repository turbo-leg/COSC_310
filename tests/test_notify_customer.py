...
def test_notify_customer_valid():
    """ Test case to validate that notify_customer returns the correct order status for a valid user. """
    database.users_map = {
    ...
    result = database.notify_customer(1, "Your order has been received.")
...
def test_notify_customer_invalid_user():
    ...
    result = database.notify_customer(999, "Your order has been received.")
