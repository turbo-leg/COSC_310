...
def test_search_restaurants_by_name():
    """Test restaurant search against menu-derived display names."""
    database.menu_items = [
        {
            "itemId": 1, "restaurantId": 10, "name": "A", "description": "",
            "price": 1.0, "isActive": True,
        },
        {
            "itemId": 2, "restaurantId": 20, "name": "B", "description": "",
            "price": 1.0, "isActive": True,
        },
    ]
    results = database.search_restaurants_by_name("10")
    assert len(results) == 1
    assert results[0]["name"] == "Restaurant 10"

def test_search_restaurants_by_name_no_match():
    """Test restaurant search with no match."""
    database.menu_items = [
        {
            "itemId": 1, "restaurantId": 10, "name": "A", "description": "",
            "price": 1.0, "isActive": True,
